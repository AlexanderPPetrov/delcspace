...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner">
		<div class="logo-container container hidden-xs" style="position:relative;">
			<div id="logo">
			...
			<aside id="search" class="widget widget_search col-sm-3 pull-right" style="position: absolute;
    right: 0;
    top: 30px;">
				<?php get_search_form(); ?>
			</aside>
